...
public final class PromptConstants {
    ...
    public static final String SUMMARIZE_PROMPT_TEMPLATE = """
        ...
        **建议**：提供更长、信息量更大的视频内容。
        ...
        ---
        基于以上视频字幕内容，请生成一份详细的总结。

        【输出格式要求】
        请使用 **Markdown 格式** 输出，包含以下部分：
        - ## 核心主题（1-2 句话）
        - ## 主要内容（3-5 条要点，使用 - 列表）
        - ## 关键结论或建议
    ...
    public static final String CHAT_PROMPT_TEMPLATE = """
        ...
        助手回答（Markdown格式）：
        根据视频 [00:05:20] 处的内容，**提示工程**是与AI沟通的核心技能，
        ...
        - **[00:10:15]** RAG全称是**检索增强生成**（Retrieval-Augmented Generation）
        - **[00:10:45]** 它结合了检索系统和生成模型的优势
        ...
        请基于以上视频字幕回答问题。回答时：
        1. 尽可能引用具体时间戳，格式为 **[00:MM:SS]**
        2. 关键概念使用 **加粗** 强调
        3. 如果视频中没有相关内容，请直接说明"视频中未提及"
        """;
